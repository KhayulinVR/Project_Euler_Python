...
for i in range(16):
    for j in range(16):
        mult=matrix[i][j]*matrix[i+1][j+1]*matrix[i+2][j+2]*matrix[i+3][j+3]
        if mult>max:
            max=mult
for i in range(16):
    for j in range(16):
        mult=matrix[i][19-j]*matrix[i+1][19-j-1]*matrix[i+2][19-j-2]*matrix[i+3][19-j-3]
        if mult>max:
            max=mult
print(max)
print("ответ?")